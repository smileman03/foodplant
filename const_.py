...
ERRORWEIGHT3MAX = 105
ERRORBUNKER = 106
ERRORLOADRECEPT = 201  # ошибка загрузки рецепта -  не выделена банка под продукт
ERRORLOADRECEPT2 = 202 # ошибка загрузки рецепта -  будкеры с необходмим продуктом пусты
